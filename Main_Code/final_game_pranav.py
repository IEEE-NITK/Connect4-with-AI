...
FINISH_FONT = pygame.font.SysFont('arial', 90)
...
def draw_board():
	...
	for r in range(MAX_ROWS + 1):
		for c in range(MAX_COLS):
			pygame.draw.circle(screen,BLACK,(c*100 + 50,r*100 + 50),40)
	pygame.draw.rect(screen,BLACK,(0,0,WIDTH,100))
	pygame.draw.rect(screen,BLACK,(0,(MAX_ROWS+1)*100,WIDTH,100))
...
def draw_main_screen():
	...
	screen.blit(Name, (5,200))

	pygame.draw.rect(screen, (255,0,0), (150, 390, 435, 100))
	...
	screen.blit(SinglePlayer, (160,390))
	screen.blit(MultiPlayer, (190,520))
	...
	while(True):
		for event in pygame.event.get():
			...
			if event.type == pygame.MOUSEBUTTONDOWN:
				x_val = event.pos[0]
				y_val = event.pos[1]
				if x_val >= 150 and x_val <= 585 and y_val >= 390 and y_val <= 490 :
						return 1
				if x_val >= 180 and x_val <= 560 and y_val >= 520 and y_val <= 620 :
						return 2
...
def draw_singleplayer():
	...
	screen.blit(Diff, (80,100))


	pygame.draw.rect(screen, (0,255,0), (200, 260, 300, 100))
	pygame.draw.rect(screen, (0,0,255), (200, 390, 300, 100))
	pygame.draw.rect(screen, (255,0,0), (200, 520, 300, 100))	
	...
	screen.blit(Easy, (270,260))
	screen.blit(Medium, (220,390))
	screen.blit(Hard, (270,520))
...
def set_player():
	...
	pygame.draw.rect(screen, (0,0,255), (170, 500, 350, 100))
	
	You = WINNER_FONT.render("You", True, WHITE)
	Comp = WINNER_FONT.render("Computer", True, WHITE)
	screen.blit(You, (290,370))
	screen.blit(Comp, (180,500))
	...
	while(True):
		for event in pygame.event.get():
			...
			if event.type == pygame.MOUSEBUTTONDOWN:
				x_val = event.pos[0]
				y_val = event.pos[1]
				if x_val >= 200 and x_val <= 500 and y_val >= 370 and y_val <= 470:
						return 1
				if x_val >= 170 and x_val <= 520 and y_val >= 500 and y_val <= 600:
						return 2
		...
		for event in pygame.event.get():
			...
			if event.type == pygame.MOUSEBUTTONDOWN:
				...
				if(valid_choice(board,choice)):
					...
					if(winner == 1):
						screen.blit(WINNER_FONT.render("Player 1 Won!", True, RED),(110,(MAX_ROWS+1)*100))
						...
						screen.blit(WINNER_FONT.render("Player 2 Won!", True, YELLOW),(110,(MAX_ROWS+1)*100))
						game_over = FINISH_FONT.render("GAME OVER!", True, (0,255,0))
						screen.blit(game_over, (60,240))
						ONGOING = False
						pygame.display.update()
						...
						screen.blit(WINNER_FONT.render("Draw", True, (0,255,0)),(190,(MAX_ROWS+1)*100))
						game_over = FINISH_FONT.render("GAME OVER!", True, (0,255,0))
						screen.blit(game_over, (60,240))
						ONGOING = False
						pygame.display.update()
				...
				if event.type == pygame.MOUSEBUTTONDOWN:
					...
					if(valid_choice(board, choice)):
						...
						if(winning_check(board,row,choice)):
							screen.blit(WINNER_FONT.render("Player Won!", True, RED),(150,(MAX_ROWS+1)*100))
							game_over = FINISH_FONT.render("GAME OVER!", True, (0,255,0))
							screen.blit(game_over, (60,240))
							ONGOING = False
							pygame.display.update()
						...
						if(winning_check(board,bestMove[0], bestMove[1])):
							screen.blit(WINNER_FONT.render("Computer Won!", True, YELLOW),(100,(MAX_ROWS+1)*100))
							game_over = FINISH_FONT.render("GAME OVER!", True, (0,255,0))
							screen.blit(game_over, (60,240))
							ONGOING = False
							pygame.display.update()
			...
			for event in pygame.event.get():
				...
				if event.type == pygame.MOUSEBUTTONDOWN:
					...
					if(valid_choice(board, choice)):
						...
						MOVES += 1
						if(winning_check(board,row,choice)):
							screen.blit(WINNER_FONT.render("Player Won!", True, YELLOW),(150,(MAX_ROWS+1)*100))
							game_over = FINISH_FONT.render("GAME OVER!", True, (0,255,0))
							screen.blit(game_over, (60,240))
							ONGOING = False
							pygame.display.update()
						...
						MOVES += 1
						if(winning_check(board,bestMove[0], bestMove[1])):
							screen.blit(WINNER_FONT.render("Computer Won!", True, RED),(100,(MAX_ROWS+1)*100))
							game_over = FINISH_FONT.render("GAME OVER!", True, (0,255,0))
							screen.blit(game_over, (60,240))
							ONGOING = False
							pygame.display.update()
