...
def draw_main_screen():
	...
	Welcome = Initial_Font.render("Welcome to our", True, white)
	screen.blit(Welcome, (60,100))

	Name = Initial_Font.render("Connect-4 Game", True, white)
...
def draw_singleplayer():
	...
	Diff = Winning_Font.render("Choose Difficulty", True, white)
...
def set_player():
	...
	Welcome = Initial_Font.render("Who will make the", True, white)
	screen.blit(Welcome, (20,100))

	Name = Initial_Font.render("First Move", True, white)
	screen.blit(Name, (150,200))

	pygame.draw.rect(screen, red, (200, 370, 300, 100))
	pygame.draw.rect(screen, blue, (200, 500, 300, 100))
